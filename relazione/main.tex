...
\todo[inline]{Riempire con i dati}
...
\textbf{Performance Metric} & \textbf{INTENSE WRITING} & \textbf{INTENSE READING} \\
\hline
\textbf{Total Completed Operations} & X ops & X ops \\
\hline
\textbf{Total Execution Time} & X seconds & X seconds \\
\hline
\textbf{System Throughput} & X ops/sec & X ops/sec \\
\hline
\textbf{Average Request Latency} & X ms & X ms \\
\hline
\end{tabular}

...
\begin{itemize}
    ...
    \item \texttt{workloadConsistency}: carica 5000 utenti e fa 1000 operazioni casuali senza concorrenza testando le performance sui 3 diversi \textbf{consistency level}
...
\hline
\textbf{Total Execution Time} & 2.14 s & 2.13 s \\
\hline
\textbf{System Throughput} & 1170.94 ops/s & 1172.66 ops/sec \\
\hline
\textbf{Average Request Latency} & 20.35 ms & 20.10 ms \\
\hline
\end{tabular}
...
Poiché l'esecuzione soprattutto di \texttt{workloadScalability} é molto influenzata dal fatto che i nodi si trovino sulla stessa macchina, seppur in container diversi, per questo workload sono stati eseguiti 3 nodi ognuno su un \textbf{PC diverso} (tutto ciò é stato fatto sul branch \texttt{lan} per differenziarsi dalla configurazione in locale).\newline
...
\textbf{Total Completed Operations} & 2500 ops & 2500 ops \\
\hline
\textbf{Total Execution Time} & 1.02 seconds & 2.01 seconds \\
\hline
\textbf{System Throughput} & 2442.88 ops/sec & 1242.17 ops/sec \\
\hline
\textbf{Average Request Latency} & 9.95 ms & 19.74 ms \\
\hline
\end{tabular}
...
\textbf{Total Completed Operations} & 2500 ops & 2500 ops \\
\hline
\textbf{Total Execution Time} & 7.99 seconds & 3.22 seconds \\
\hline
\textbf{System Throughput} & 312.84 ops/sec & 776.79 ops/sec \\
\hline
\textbf{Average Request Latency} & 75.84 ms & 31.46 ms \\
\hline
\end{tabular}
...
\noindent
Come quindi spiegato nella sezione \ref{s_test_dist} sono state eseguiti 3 nodi su 3 macchine diverse e ciò ha portato a XXXXXXXXXXXXXXXXXXXXXX

\todo[inline]{Conclusioni sui nodi distribuiti}

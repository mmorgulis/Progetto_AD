"""
This workload tests the fault tolerance with 3 nodes, CL = ALL and RF = 2. 
"""
...
def test_cl_all():
    print("=" * 80)
    print("        FAULT TOLERANCE EVALUATION - CONSISTENCY LEVEL: ALL        ")
    print("=" * 80)
    
    db = DBLogic(consistency_level=ConsistencyLevel.ALL)
    db.query_logger_enabled = True
    db.session.default_timeout = 120.0

    # Ensure all 4 nodes are initially up
